...
class Params():
    def __init__(self):
        ...
        self.env_name = 'boeing-danger-v0'
...
shared_model = DDPG(3, env.action_space) # shared_model is the model shared by the different agents (different threads in different cores)
