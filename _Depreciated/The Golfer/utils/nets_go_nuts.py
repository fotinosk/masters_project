...
- Added additional linear layer, to facilitate classification
"""
...
class Actor(nn.Module):
    def __init__(self, hidden_size, num_inputs, action_space):
        ...
        # Output Layer
        self.mu = nn.Linear(hidden_size[3], num_outputs)
        ...
        fan_in_uniform_init(self.linear4.weight)
        fan_in_uniform_init(self.linear4.bias)
