...
Sticky control:
With a probability p, the action given will not be executed, instead the previous 
...
class LunarLander(gym.Env, EzPickle):
    ...
    def reset(self, mode=None):
        ...
        if mode == 0:
            ...
            print("Mode 3 - Sticky controller")
    ...
    def step(self, action):
        ...
        if self.mode == 3 and random.random() < STICKY_PROB:
...
class StickyMITrain(LunarLander):
    continuous = True
