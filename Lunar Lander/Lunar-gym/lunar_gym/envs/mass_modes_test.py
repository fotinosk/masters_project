"""
3 different mass modes, default = 4.1666, alt = 3, interporate to 3.5
"""
...
class LunarLander(gym.Env, EzPickle):
    ...
    def reset(self):
        ...
        if mode == 1:
            ...
            self.lander.mass = INT_MASS
            print(f'Mode 2: Mass set to {INT_MASS}')
        elif mode == 0:
...
class MassModeTest(LunarLander):
    continuous = True
