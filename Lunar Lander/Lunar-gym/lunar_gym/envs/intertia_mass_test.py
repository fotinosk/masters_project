...
4. inertia set to 9 
5. mass set to 4
6. mass set to 3 and inertia set to 8
"""
...
class LunarLander(gym.Env, EzPickle):
    ...
    def reset(self, mode=None):
        ...
        if mode == 0:
            ...
            print(f'Mode 3 - Inertia set to {INT_I}')
            self.lander.inertia = INT_I
        elif mode == 4:
            print(f'Mode 4 - Mass set to {INT_M}')
            self.lander.mass = INT_M
        elif mode == 5:
            print(f"Mode 5 - Mass set to {ALT_M} and Inertia set to {ALT_I}")
            self.lander.inertia = ALT_I
            self.lander.mass = ALT_M
...
class InertiaMassTest(LunarLander):
    continuous = True
