"""
2 different mass modes, default sticky controller
"""
...
class LunarLander(gym.Env, EzPickle):
    ...
    def reset(self, mode=None):
        ...
        if mode == 0:
            ...
            print(f'Mode 1 - Sticky Controller')
    ...
    def step(self, action):
        ...
        if self.mode == 1 and random.random() < STICKY_PROB:
...
class StickyModeTrain(LunarLander):
    continuous = True
