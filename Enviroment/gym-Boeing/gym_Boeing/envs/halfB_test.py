"""
This module tests the 1st failure mode of the plane. It is trained with the B matrix being 0.5 its 
original value, and is now tested with 0.5B and 0.75B.
...
class FailureMode4(gym.Env):
    """
    Gym enviroment containing the normal modeo of operation and on with an ineffective B matrix
    """
    ...
    def __init__(self):
        ...
        """        
        self.done = False
        self.flight = Flight(failure_modes=[[A,B_err,C,D], [A,B_err2,C,D]])
